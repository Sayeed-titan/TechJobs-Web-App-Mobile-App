    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobTechStacks", x => new { x.JobId, x.TechStackId });
                    table.ForeignKey(
                        name: "FK_JobTechStacks_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobTechStacks_TechStacks_TechStackId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobTechStacks_TechStackId",
                table: "JobTechStacks",
                column: "TechStackId");
